...
from config import LEAGUE_ID, MY_TEAM_ID
...
class FantraxApp:
    ...
    def run(self) -> None:
        ...
        start_date, end_date = schedule_service.get_week_dates(league_info, current_period)
        console.print_week_dates(current_period, start_date, end_date)
        nba_games_by_team = self.get_nba_games_by_team(start_date, end_date)
        console.print_nba_games(nba_games_by_team)
